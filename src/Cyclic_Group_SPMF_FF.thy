...
theory Cyclic_Group_SPMF_FF imports
  CryptHOL.Cyclic_Group
  "HOL-Probability.SPMF"
  Berlekamp_Zassenhaus.Finite_Field
begin

definition sample_uniform :: "nat \<Rightarrow> 'a::finite mod_ring spmf"
where "sample_uniform n = spmf_of_set ((of_int_mod_ring \<circ> int::nat \<Rightarrow> 'a mod_ring) ` {..<n})"
